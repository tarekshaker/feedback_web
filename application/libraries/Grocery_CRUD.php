...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
    ...
    protected function get_upload_file_input($field_info, $value)
    {
        ...
        //Upload button instead of delete (Tarek Shaker)
...
class UploadHandler
{
    ...
    private function trim_file_name($name, $type) {
        ...
        $file_name = substr(uniqid(),-5).'_'.$this->_transliterate_characters($file_name);
    ...
    private function _transliterate_characters($file_name)
    {
        ...
        $file_name = preg_replace("/([^a-zA-Z0-9\.\-\_]+?){1}/i", '_', $file_name);
        $file_name = str_replace(" ", "_", $file_name);

        return preg_replace('/\-+/', '_', trim($file_name, '-'));
    }
